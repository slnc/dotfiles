...
FIELDS=SSID,SECURITY,CHAN,FREQ,RATE,SIGNAL,BARS,SECURITY
POSITION=0
YOFF=0
XOFF=0
...
CHENTRY=$(echo -e "$TOGGLE\nmanual\n$LIST" | uniq | rofi -dmenu -p "Wi-Fi SSID: " -lines "$LINENUM" -a "$HIGHLINE" -location "$POSITION" -yoffset "$YOFF" -xoffset "$XOFF" -font "$FONT" -width -"$RWIDTH")
#echo "$CHENTRY"
